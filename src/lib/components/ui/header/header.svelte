<script lang="ts">
  import logo from '$lib/assets/pw-logo.png';
...
<header
  ...
  class={floating
    ...
    : undefined}
>
  <div class="flex justify-between items-center max-w-5xl mx-auto px-4 md:px-0">
    <HeaderMobileMenu />
    <a href={localisedResolve('/')}>
      <img src={logo} alt={m.logo()} class="h-24 w-24" />
    </a>
